...
Pod::Spec.new do |s|
  ...
  s.homepage = "https://github.com/shuihong/react-native-qqsdk-without-mta.git"
  s.license  = package['license']
  s.author   = package['author']
  s.source   = { :git => "https://github.com/shuihong/react-native-qqsdk-without-mta.git", :tag => "v#{s.version}" }
